...
static const struct HealLocation sHealLocations[NUM_HEAL_LOCATIONS - 1] = {
    ...
    [HEAL_LOCATION_INMALD_TOWN - 1] = {
        .mapGroup = MAP_GROUP(MAP_INMALD_TOWN),
        .mapNum = MAP_NUM(MAP_INMALD_TOWN),
        .x = 10,
        .y = 7,
    },
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[NUM_HEAL_LOCATIONS - 1][2] = {
    ...
    [HEAL_LOCATION_INMALD_TOWN - 1] = { MAP_GROUP(MAP_PLAYERS_HOUSE), MAP_NUM(MAP_PLAYERS_HOUSE)},
};
